...
def test_sig_split_4_sbt_prot(c):
    ...
    outlist = [
        "16869d2c.k=57.scaled=100.protein.dup=0.GCA_001593925.1_ASM159392v1_protein.faa.gz.sig",
...
def test_sig_split_4_lca_prot(c):
    ...
    outlist = [
        "16869d2c.k=57.scaled=100.protein.dup=0.none.sig",
...
def test_sig_describe_protein(c):
    ...
    assert (
        "k=57 molecule=protein num=0 scaled=100 seed=42 track_abundance=0"
...
def test_sig_describe_hp(c):
    ...
    assert (
        "k=57 molecule=hp num=0 scaled=100 seed=42 track_abundance=0"
        in c.last_result.out
    )
...
def test_sig_describe_dayhoff(c):
    ...
    assert (
        "k=57 molecule=dayhoff num=0 scaled=100 seed=42 track_abundance=0"
        in c.last_result.out
    )
